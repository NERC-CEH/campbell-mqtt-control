...
class PahoConnection(Connection):
    ...
    def _on_connect(
        self, client: Client, userdata: Any, flags: ConnectFlags, reason_code: ReasonCode, properties: Properties
    ) -> None:
    ...
    def _on_subscribe(
        self, client: Client, userdata: Any, mid: int, reason_code_list: List[ReasonCode], properties: Properties
    ) -> None:
